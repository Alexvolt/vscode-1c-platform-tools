 ...
 *
 * Панель проектов - единственное место, откуда проект открывают, цели отладки живут
 * по состоянию отладки, а панель «1С: Администрирование» к рабочей области не привязана:
...
const ALWAYS_AVAILABLE = new Map<string, string>([
	...
	['1c-platform-tools-admin-clusters', 'администрирование кластера не зависит от рабочей области'],
	['1c-platform-tools-admin-infobases', 'список информационных баз платформы не зависит от рабочей области'],
	['1c-platform-tools-admin-help', 'панель администрирования не зависит от рабочей области'],
	['1c-platform-tools-debug-targets', 'показывается по состоянию отладки'],
]);
...
suite('видимость представлений', () => {
	test('вне проекта 1С видны только проекты, администрирование и цели отладки', () => {
