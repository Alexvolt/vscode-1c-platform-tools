...
Панели открываются номером в том же порядке, в каком они стоят в activity bar.
...
<img src="../resources/brand/bird-warn.png" alt="" width="28" align="left"> Три сочетания конфигуратора заняты в VS Code: <kbd>F7</kbd> ведёт к следующему отличию в сравнении файлов, <kbd>Alt</kbd>+<kbd>Enter</kbd> выделяет все совпадения поиска, <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>C</kbd> открывает внешний терминал. Расширение их не трогает.
